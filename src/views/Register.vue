    ...
    <form class="glitch-card" @submit="onSubmit">
      <div class="card-header">
        <div class="card-title">
          ...
          <span>CREATE_SECURE_ACCOUNT</span>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <input id="email" name="email" v-model="form.email"
                 type="email" autocomplete="off" required placeholder=" " />
        ...
        >
          <span class="btn-text">
            {{ authStore.isLoading ? 'LOADING...' : 'CREATE_ACCOUNT' }}
          </span>
        </button>
      </div>
    </form>
...
<style scoped>
/* Copiez exactement le même style que Login.vue */
.glitch-form-wrapper {
  --bg-color: #0d0d0d;
