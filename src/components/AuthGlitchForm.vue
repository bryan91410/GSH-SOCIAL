...
/**
 * Props :
 * - title: texte de l’entête (ex: "SECURE_DATA")
 * - fields: tableau de champs [{ id, label, type }]
 * - submitText: texte du bouton
 */
const props = defineProps({
  title: { type: String, default: 'SECURE_DATA' },
  fields: {
    type: Array,
    default: () => ([
      { id: 'username', label: 'USERNAME', type: 'text' },
      { id: 'password', label: 'ACCESS_KEY', type: 'password' }
    ])
  },
  submitText: { type: String, default: 'INITIATE_CONNECTION' }
})
  ...
  <div class="glitch-form-wrapper">
    <form class="glitch-card" @submit="onSubmit">
      ...
      <div class="card-body">
        ...
        <button class="submit-btn" type="submit" :data-text="submitText">
